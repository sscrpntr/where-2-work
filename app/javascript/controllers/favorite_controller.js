...
export default class extends Controller {
  ...
  removeFavoriteVenueShow(event) {
    ...
    fetch(url, {
      ...
      .then(response => response.json())
      .then((data) => {
        this.element.innerHTML= `<a data-turbo-method="post" href="/venues/${this.venueIdValue}/favorite_venues"><i class="fa-regular fa-heart fav-background-show" data-action="click->favorite#drefresh"></i></a>`
      })

  }

  addFavoriteVenueShow(event) {
    ...
    fetch(url, {
      ...
      .then(response => response.json())
      .then((data) => {
        this.element.innerHTML= `<a data-turbo-method="delete" href="/venues/${this.venueIdValue}/favorite_venues"><i class="fa-solid fa-heart fav-background-show" data-action="click->favorite#refresh"></i></a>`
      })
